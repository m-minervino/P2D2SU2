...
This consists in a set of two elementary codes that perform grid coarsening and conversion to **SU2** native format, from a *two-dimensional* **PLOT3D** file generated by the program [*CONSTRUCT2D*](https://sourceforge.net/projects/construct2d/). Pre-compiled executables for win64 are also included.
